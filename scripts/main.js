...
const search = (event) => {
  ...
  const searchResult = referenceList.filter(descrip => 
    descrip.title.toLowerCase().includes(userInput) ||
    descrip.author.toLowerCase().includes(userInput) ||
    descrip.description.toLowerCase().includes(userInput)
  )
